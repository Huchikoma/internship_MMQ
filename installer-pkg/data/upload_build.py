...
xml_data_dirpath = "xml-build" # Name a new folder under the same directory of upload_<type>.py
...
for xml_filename in listdir(xml_data_dirpath):
    with open(join(xml_data_dirpath, xml_filename), "r") as xml_file:
        ...
        data = {
            "title": xml_filename,
            "schema": "5b8f6dc1ef370cda2fc1ca46", # Schema can be found in "Record" page, under title "Associated schema ID"
            "content": xml_content
        }
