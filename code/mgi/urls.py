...
from data_mining import views as data_views

urlpatterns = patterns('',
    url(r'^$', 'mgi.views.home', name='landing_page'),
    ...
    # data visual
    url(r'new', 'data_visual.views.index'),
    url(r'^myurl$', 'data_visual.views.query_1'),
    url(r'^myurl2$', 'data_visual.views.choose_1'),
    url(r'^myurl3$', 'data_visual.views.query_2'),

    # data mining
    url(r'^pattern$','data_mining.views.index1'),
    url(r'^pattern1$','data_mining.views.index'),
